...
import com.ada.model.DensityToGlobalValue;
...
@Getter
@Setter
public class TrackPoint extends Point implements Cloneable, Comparable<TrackPoint>, Serializable, DensityToGlobalValue{
