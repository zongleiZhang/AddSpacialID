...
public abstract class GNode implements Serializable {
    ...
    abstract GNode cloneNode() throws CloneNotSupportedException;
    ...
    /**
     * 查找本子树与point相交的叶节点，将叶节点存储在leafs中
     */
    public abstract void getIntersectLeafNodes(Point point, List<GDataNode> leafs);
    ...
    abstract void setNodeTree(GTree tree);
}
